  ...
  <ul class="navbar-nav ml-auto">
      ...
      <div class="topbar-divider d-none d-sm-block"></div>
		...
		<!-- 스프링 시큐리티 표현식
			...
			- denyAll : 모든 사용자를 거부
			- isAnoymous() : 로그인 하지 않은 경우 해당
			- isAuthenticated() : 로그인한 경우 true
			- isFullyAuthenticated() : Remember-me(로그인 저장)로 
				인증된 것이 아닌 일반적인 방법으로 인증된 사용자의 경우 true
				
		 -->

	  <!---------------------- 로그인 함 시작 ---------------------->
	  <!-- 권한 : authorize 로그인 : Authenticate -->
	  <sec:authorize access="isAuthenticated()">
	  <!-- Customer.java에서 private MemVO memVO 멤버변수를 principal객체를 통해 사용 가능 -->
      ...
      <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
              ...
              <img class="img-profile rounded-circle"
                  src="/resources/sbadmin2/img/KakaoTalk_20230127_171125196.jpg">
          </a>
	  ...
	  <!-- isAnonymous : 익명 -->
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="/login" id="userDropdown" role="button"
              ...
              <img class="img-profile rounded-circle"
                  src="/resources/sbadmin2/img/login.jpg">
          </a>
        </li>
        </sec:authorize>
	  <!--------------------- 로그인 안함 끝 ---------------------->
